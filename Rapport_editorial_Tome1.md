# RAPPORT ÉDITORIAL — LA VIE BELLE
...
1. [Corrections à faire avant publication (🔴)](#1-corrections-à-faire-avant-publication-)
2. [Corrections fortement recommandées (🟠)](#2-corrections-fortement-recommandées-)
3. [Améliorations optionnelles (🟢)](#3-améliorations-optionnelles-)
4. [Détail des incohérences détectées](#4-détail-des-incohérences-détectées)
5. [Bilan par thème](#5-bilan-par-thème)
6. [Passages particulièrement réussis](#6-passages-particulièrement-réussis)
7. [Tableau récapitulatif complet](#7-tableau-récapitulatif-complet)

---

## 1. Corrections à faire avant publication (🔴)

### 1.1 — Résidu de texte hors-fiction entre les Chapitres 28 et 29

Entre la fin du Chapitre 28 et l'en-tête « CHAPITRE 29 », ce fragment s'est glissé dans le manuscrit :
...
- **Chapitre 21** se termine par la découverte des hématomes d'Émilie par Rose et la lecture, par Léa, d'une feuille tombée de son sac — mais Émilie n'a encore jamais prononcé le mot « leucémie » à voix haute.
- **Chapitre 24** reprend littéralement la même scène (même cabine d'essayage) et montre l'aveu verbal *pour la première fois* : « J'ai une leucémie », suivi du *premier* cadeau d'un carnet-exutoire par Léa.
...
- Chapitres 7, 12, 17-19, 22 : le lieu est tenu par **Monsieur Dalpond** (vendeur de jus, propriétaire de la boutique) ; **Adrien** y anime le cercle de parole.
- À partir du Chapitre 25, un personnage nommé **Daniel** occupe exactement le rôle d'Adrien (accompagnement calme, exercices de respiration/réflexion) — Adrien n'est plus jamais nommé après le Ch.22.
...
- Chapitre 1, l.120 : « Claire tient une petite boutique de pâtisserie **depuis quelques années**. » (confirmé Ch.20, l.2331).
...
- Apostrophes droites (`'`) : ~3279 occurrences vs apostrophes courbes (`'`) : ~664 — mélangées, parfois dans la même scène.
...
## 2. Corrections fortement recommandées (🟠)

### 2.1 — Trois personnages secondaires nommés « Sophie »

- Sophie, l'infirmière du centre de don du sang (Ch.3).
- Sophie, l'éducatrice du centre où travaille Léa (Ch.22).
...
Le manuscrit alterne deux formats sans logique apparente :
- Sous-titre sur une ligne séparée, casse normale (« CHAPITRE 2 » / « Le retour »).
- Sous-titre accolé après un tiret, parfois tout en majuscules (« CHAPITRE 10 — LE MEILLEUR INVESTISSEMENT »), parfois en casse normale (« CHAPITRE 21 — Avant que tout ne bascule »).
...
- **Quatre espaces manquantes après un point** (probablement des coquilles de frappe lors de la rédaction de phrases courtes groupées dans un même paragraphe) :
  - Ch.17, l.1689 : « Clic.Clac. » *(peut-être volontaire — effet sonore)*
  - Ch.19, l.2270 : « ...m'arrive.Mais je peux... »
  - Ch.22, l.2970 et l.2972 : plusieurs phrases collées sans espace.
...
*(Format complet avec passages cités — voir sections 1.2 à 1.4 ci-dessus pour le texte intégral des passages en vis-à-vis.)*
...
**Personnages** — Cohérents et bien construits sur la durée (Émilie, Rose, Claire, Léa, Thomas, Alma, Simon, Daniel, Monsieur Dalpond, le Cercle). Les seuls défauts concernent des noms qui se chevauchent (voir §1.3 et §2.1), jamais la substance des personnages.

**Chronologie** — Solide sur l'ensemble des 39 chapitres, à l'exception du point détaillé en §1.2.

**Intrigue** — Progression très maîtrisée (vacances → signes → diagnostic caché → confrontation avec Alma → révélation → traitement → reconstruction → rémission partielle). Structure en miroir réussie entre les titres des Ch.21 et Ch.28.

**Rythme** — Excellent équilibre entre intime, choral et comique. Le Ch.16 (syntaxe fragmentée) est un choix de rythme fort et cohérent.

**Dialogues** — Point fort constant : chaque personnage a une voix reconnaissable dès sa première apparition.

**Style** — Voix cohérente (présent de narration, motifs récurrents : galets, couleurs, carnets, contrôle/lâcher-prise).

**Point de vue narratif** — Deux chapitres (22 et 38) sortent du « je » d'Émilie pour suivre Léa puis Alma à la troisième personne. Avec deux occurrences, il s'agit très probablement d'un dispositif volontaire et réussi (chapitres « invités »), pas d'un glissement involontaire — à confirmer avec vous.

**Grammaire / Orthographe** — Rien de significatif à signaler sur l'ensemble du tome.

**Ponctuation** — Voir §1.5 et §3.

**Répétitions** — Rien de problématique à l'échelle du tome.

---

## 6. Passages particulièrement réussis

- Le rituel des galets peints (Ch.1)
- La scène du dessin de Mathieu par Léa (Ch.22)
- La robe de mariée vandalisée et l'aveu (Ch.24)
- La tondeuse partagée entre Émilie et Daniel (Ch.32)
- Le chapitre entier consacré à la rédemption d'Alma (Ch.38)
- La fête sur le toit de l'hôpital (Ch.33)
- La clôture du tome et l'épilogue (Ch.39)

Ces scènes comptent parmi les plus abouties du manuscrit : sobres, jamais complaisantes, toujours ancrées dans le concret plutôt que dans le discours explicatif.
